...
# Writes thumbnail.gif (240x240, the diagram appearing) and gallery-1..3.png
# (1270x760) beside the video. The times are where the beats land in the
# current script; the render prints them, so adjust here if they move.
set -eu
...
# desktop go.
i=1
for t in ${GALLERY_AT:-9.9 26.8 36.2}; do
